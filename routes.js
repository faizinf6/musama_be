...
router.patch('/update-kelas/:nis',Controller.updateOneKelas)
router.delete('/delete-santri-kelas',Controller.deleteOneKelas)
router.post('/duplicate-kelas-santri',Controller.findDuplicatesKelasSantri)
...
router.delete('/delete-filter-mesin',Controller.deleteOneFilter)
...
router.patch('/update-banyak-admin',Controller.updateManyAdmins)

router.get('/get-guru-lembaga/:lembaga',Controller.findAdminPerlembaga)
